...
titlelabel=Label(home,image=titleimg,width=80,height=40)
...
loginbutton=Button(home,text='會員登入/註冊',font=('Inter',18),fg='#1E1E1E',bg='#F8DCDC',width=12,pady=2,command=logWin)
...
bannerLabel=Label(home,image=banner,width=750,height=500)
...
p1Label=Label(home,image=p1,width=202,height=200)
...
p2Label=Label(home,image=p2,width=202,height=200)
...
p3Label=Label(home,image=p3,width=202,height=200)
...
p4Label=Label(home,image=p4,width=202,height=200)
...
p5Label=Label(home,image=p4,width=202,height=200)
...
p6Label=Label(home,image=p4,width=202,height=200)
...
p7Label=Label(home,image=p4,width=202,height=200)
...
p8Label=Label(home,image=p4,width=202,height=200)
...
p9Label=Label(home,image=p4,width=202,height=200)
...
p10Label=Label(home,image=p4,width=202,height=200)
...
p11Label=Label(home,image=p4,width=202,height=200)
...
p12Label=Label(home,image=p4,width=202,height=200)
...
p13Label=Label(home,image=p4,width=202,height=200)
...
p14Label=Label(home,image=p4,width=202,height=200)
...
p15Label=Label(home,image=p15,width=202,height=200)
...
p16Label=Label(home,image=p16,width=202,height=200)
...
p17Label=Label(home,image=p17,width=202,height=200)
p17Label.grid(row=2,column=6,columnspan=2,sticky=W,padx=5)

namel1=Label(home,text='hamburger',font=('Inter',10),fg='#000000')
namel1.grid(row=3,column=0,columnspan=2,sticky=W,padx=5)

namel2=Label(home,text='banna',font=('Inter',10),fg='#000000')
namel2.grid(row=3,column=2,columnspan=2,sticky=W,padx=5)

namel3=Label(home,text='cheery',font=('Inter',10),fg='#000000')
namel3.grid(row=3,column=4,columnspan=2,sticky=W,padx=5)

namel4=Label(home,text='raw salmon',font=('Inter',10),fg='#000000')
namel4.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel5=Label(home,text='pears',font=('Inter',10),fg='#000000')
namel5.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel6=Label(home,text='mango',font=('Inter',10),fg='#000000')
namel6.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel7=Label(home,text='soup',font=('Inter',10),fg='#000000')
namel7.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel8=Label(home,text='strawberry',font=('Inter',10),fg='#000000')
namel8.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel9=Label(home,text='pan cakes',font=('Inter',10),fg='#000000')
namel9.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel10=Label(home,text='pineapple',font=('Inter',10),fg='#000000')
namel10.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel11=Label(home,text='lemon',font=('Inter',10),fg='#000000')
namel11.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel12=Label(home,text='apple',font=('Inter',10),fg='#000000')
namel12.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel13=Label(home,text='beef',font=('Inter',10),fg='#000000')
namel13.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel14=Label(home,text='beef noodles',font=('Inter',10),fg='#000000')
namel14.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel15=Label(home,text='404',font=('Inter',10),fg='#000000')
namel15.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel16=Label(home,text='404',font=('Inter',10),fg='#000000')
namel16.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)

namel17=Label(home,text='404',font=('Inter',10),fg='#000000')
namel17.grid(row=3,column=6,columnspan=2,sticky=W,padx=5)


pl1=Label(home,text='NT.89',font=('Inter',10),fg='#000000')
pl1.grid(row=4,column=0,sticky=W,padx=5)

pl2=Label(home,text='NT.40',font=('Inter',10),fg='#000000')
pl2.grid(row=4,column=2,sticky=W,padx=5)

pl3=Label(home,text='NT.55',font=('Inter',10),fg='#000000')
pl3.grid(row=4,column=4,sticky=W,padx=5)

pl4=Label(home,text='NT.65',font=('Inter',10),fg='#000000')
pl4.grid(row=4,column=6,sticky=W,padx=5)

pl4=Label(home,text='NT.60',font=('Inter',10),fg='#000000')
pl4.grid(row=4,column=6,sticky=W,padx=5)

pl5=Label(home,text='NT.20',font=('Inter',10),fg='#000000')
pl5.grid(row=4,column=6,sticky=W,padx=5)    

pl6=Label(home,text='NT.50',font=('Inter',10),fg='#000000')
pl6.grid(row=4,column=6,sticky=W,padx=5)

pl7=Label(home,text='NT.120',font=('Inter',10),fg='#000000')
pl7.grid(row=4,column=6,sticky=W,padx=5)

pl8=Label(home,text='NT.110',font=('Inter',10),fg='#000000')
pl8.grid(row=4,column=6,sticky=W,padx=5)

pl9=Label(home,text='NT.115',font=('Inter',10),fg='#000000')
pl9.grid(row=4,column=6,sticky=W,padx=5)

pl10=Label(home,text='NT.60',font=('Inter',10),fg='#000000')
pl10.grid(row=4,column=6,sticky=W,padx=5)

pl11=Label(home,text='NT.25',font=('Inter',10),fg='#000000')
pl11.grid(row=4,column=6,sticky=W,padx=5)

pl12=Label(home,text='NT.30',font=('Inter',10),fg='#000000')
pl12.grid(row=4,column=6,sticky=W,padx=5)

pl13=Label(home,text='NT.499',font=('Inter',10),fg='#000000')
pl13.grid(row=4,column=6,sticky=W,padx=5)

pl14=Label(home,text='NT.150',font=('Inter',10),fg='#000000')
pl14.grid(row=4,column=6,sticky=W,padx=5)

pl15=Label(home,text='404',font=('Inter',10),fg='#000000')
pl15.grid(row=4,column=6,sticky=W,padx=5)

pl16=Label(home,text='404',font=('Inter',10),fg='#000000')
pl16.grid(row=4,column=6,sticky=W,padx=5)

pl17=Label(home,text='404',font=('Inter',10),fg='#000000')
pl17.grid(row=4,column=6,sticky=W,padx=5)


mb1=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl1,pl1))
mb1.grid(row=4,column=1,sticky=W)
numl1=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl1.grid(row=4,column=1)
ab1=Button(home,text='+',font=('Inter',12),command=lambda: add(numl1,pl1))
ab1.grid(row=4,column=1,sticky=E)

mb2=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl2,pl2))
mb2.grid(row=4,column=3,sticky=W)
numl2=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl2.grid(row=4,column=3)
ab2=Button(home,text='+',font=('Inter',12),command=lambda: add(numl2,pl2))
ab2.grid(row=4,column=3,sticky=E)

mb3=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl3,pl3))
mb3.grid(row=4,column=5,sticky=W)
numl3=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl3.grid(row=4,column=5)
ab3=Button(home,text='+',font=('Inter',12),command=lambda: add(numl3,pl3))
ab3.grid(row=4,column=5,sticky=E)

mb4=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb4.grid(row=4,column=7,sticky=W)
numl4=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl4.grid(row=4,column=7)
ab4=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab4.grid(row=4,column=7,sticky=E)

mb5=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb5.grid(row=4,column=7,sticky=W)
numl5=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl5.grid(row=4,column=7)
ab5=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab5.grid(row=4,column=7,sticky=E)

mb6=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb6.grid(row=4,column=7,sticky=W)
numl6=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl6.grid(row=4,column=7)
ab6=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab6.grid(row=4,column=7,sticky=E)

mb7=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb7.grid(row=4,column=7,sticky=W)
numl7=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl7.grid(row=4,column=7)
ab7=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab7.grid(row=4,column=7,sticky=E)

mb8=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb8.grid(row=4,column=7,sticky=W)
numl8=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl8.grid(row=4,column=7)
ab8=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab8.grid(row=4,column=7,sticky=E)

mb9=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb9.grid(row=4,column=7,sticky=W)
numl9=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl9.grid(row=4,column=7)
ab9=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab9.grid(row=4,column=7,sticky=E)

mb10=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb10.grid(row=4,column=7,sticky=W)
numl10=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl10.grid(row=4,column=7)
ab10=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab10.grid(row=4,column=7,sticky=E)

mb11=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb11.grid(row=4,column=7,sticky=W)
numl11=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl11.grid(row=4,column=7)
ab11=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab11.grid(row=4,column=7,sticky=E)

mb12=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb12.grid(row=4,column=7,sticky=W)
numl12=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl12.grid(row=4,column=7)
ab12=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab12.grid(row=4,column=7,sticky=E)

mb13=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb13.grid(row=4,column=7,sticky=W)
numl13=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl13.grid(row=4,column=7)
ab13=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab13.grid(row=4,column=7,sticky=E)

mb14=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb14.grid(row=4,column=7,sticky=W)
numl14=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl14.grid(row=4,column=7)
ab14=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab14.grid(row=4,column=7,sticky=E)

mb15=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb15.grid(row=4,column=7,sticky=W)
numl15=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl5.grid(row=4,column=7)
ab15=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab15.grid(row=4,column=7,sticky=E)

mb16=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb16.grid(row=4,column=7,sticky=W)
numl16=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl16.grid(row=4,column=7)
ab16=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
ab16.grid(row=4,column=7,sticky=E)

mb17=Button(home,text='-',font=('Inter',12),command=lambda: minus(numl4,pl4))
mb17.grid(row=4,column=7,sticky=W)
numl17=Label(home,text='0',font=('Inter',12,'bold'),fg='#000000')
numl17.grid(row=4,column=7)
ab17=Button(home,text='+',font=('Inter',12),command=lambda: add(numl4,pl4))
...
detaillistbutton=Button(home,text='詳細清單',font=('Inter',18),fg='#1E1E1E',bg='#ECEDE7',command=showdetail)
...
shoppingcartlabel=Label(home,image=cartimg,width=30,height=30)

totalval=StringVar()
totalval.set('共消費:0元') 
totallabel=Label(home,textvariable=totalval,font=('Inter',10),fg='#000000')
checkoutbutton=Button(home,text='結帳',font=('Inter',18),fg='#1E1E1E',bg='#ECEDE7',command=sell)
