...
HamburgersLabel=Label(inner_frame,image=stockHamburgers,width=202,height=200)
...
BannaLabel=Label(inner_frame,image=stockBanna,width=202,height=200)
BannaLabel.grid(row=2,column=2,columnspan=2,sticky=W,padx=5)

stpckCherries=Image.open("project/cherries-royalty-free-image-1656341880.jpg")
stpckCherries=stpckCherries.resize((202,200))
stpckCherries=ImageTk.PhotoImage(stpckCherries)
CherriesLabel=Label(inner_frame,image=stpckCherries,width=202,height=200)
...
SalmonLabel=Label(inner_frame,image=stockSalmon,width=202,height=200)
...
PearsLabel=Label(inner_frame,image=stockPears,width=202,height=200)
PearsLabel.grid(row=2,column=6,columnspan=2,sticky=W,padx=5)
...
MangoLabel=Label(inner_frame,image=stockMango,width=202,height=200)
MangoLabel.grid(row=2,column=6,columnspan=2,sticky=W,padx=5)
...
SoupLabel=Label(inner_frame,image=stockSoup,width=202,height=200)
SoupLabel.grid(row=2,column=6,columnspan=2,sticky=W,padx=5)
...
StrawberryLabel.grid(row=2,column=6,columnspan=2,sticky=W,padx=5)
...
PancakesLabel.grid(row=2,column=6,columnspan=2,sticky=W,padx=5)
...
PineappleLabel.grid(row=2,column=6,columnspan=2,sticky=W,padx=5)
